...
add_task(function* checkBuildMimeText() {
  ...
  headers.setHeader("User-Agent", "Mozilla/5.0 (X11; Linux x86_64; rv:40.0) Goanna/20100101 Thunderbird/40.0a1");
  let mimeText =
    ...
    "User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:40.0) Goanna/20100101\r\n" +
      " Thunderbird/40.0a1\r\n";
